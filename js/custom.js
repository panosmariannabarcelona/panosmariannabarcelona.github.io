...
(function($) {
    ...
    $(document).ready(function() {
        ...
        ==================================================================================== */
        var instagramTag = 'panosmarianna'; // Add Instagram Tag here
        var instagramClientId = '7b05608247db4dbc8955652e47623bc5'; // Add ClientId here
        ...
        ==================================================================================== */
        if($("#countdown").length) {
            CountDownTimer('07/25/2015 12:00 AM', 'countdown');
        }
        function CountDownTimer(dt, id) {
            ...
            function showRemaining() {
                ...
                if (distance < 0) {
                    ...
                    clearInterval(timer);
                    document.getElementById(id).innerHTML = 'Σας ευχαριστούμε όλους!';
        ...
        var widget = SC.Widget("player-widget");
        var initPosition = $.cookie('position');
        widget.bind(SC.Widget.Events.READY, function onLoadProgress (e) {

                // console.log('Well Met!');
                var initIndex = $.cookie('index');
                // var initPosition = $.cookie('position');
                setTimeout( function() {
                if (initIndex != null && initIndex != 'undefined'){
                    widget.skip(initIndex);
                    // widget.unbind(SC.Widget.Events.LOAD);
                }
                widget.play();
                if (initPosition != null && initPosition != 'undefined'){
                        widget.seekTo(initPosition);
                }
            }, 3000);
        });
